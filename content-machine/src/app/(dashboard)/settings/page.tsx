    ...
    <main className="mx-auto max-w-3xl px-4 py-12 md:px-6">
      ...
      <section className="mb-10 rounded-2xl border border-outline-variant/10 bg-surface-container p-8">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-on-surface">{t("contentDefaults")}</h2>
        </div>
        <p className="mb-6 text-sm text-zinc-400">{t("contentDefaultsDesc")}</p>
      ...
      <section className="mb-10 rounded-2xl border border-outline-variant/10 bg-surface-container p-8">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-on-surface">{t("nicheProfile")}</h2>
        </div>
        <p className="mb-6 text-sm text-zinc-400">{t("nicheProfileDesc")}</p>
      ...
      <section className="rounded-2xl border border-outline-variant/10 bg-surface-container p-8">
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-on-surface">{t("apiKey")}</h2>
        </div>
        <p className="mb-6 text-sm text-zinc-400">{t("apiKeyDesc")}</p>
        <ApiKeyPanel />
      </section>
    </main>
  );
